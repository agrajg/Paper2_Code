...
demand.data <- demand.data %>% 
  as.tbl() %>% 
  mutate(rev_date = date)
demand.data$rev_date <- as.Date(demand.data$rev_date, "%d%b%Y")
...
# text.df <- sample_frac(text.df, size = 0.01)
# gc()
# # =====================================================================================================================
...
# ---------------------------------------------------------------------------------------------------------------------
h2o.init(port = 11111, nthreads = -1, max_mem_size = '500G')
